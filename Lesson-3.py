...
dict_oft = list(my_dict.items())
dict_oft.sort(key=lambda i: i[1], reverse=True)
for i in dict_oft[:5]:
    print(i[0], ':', i[1])

# 5.1 вывести количество разных слов в тексте (set)

dict_set = set(low_list)
print(len(dict_set))
